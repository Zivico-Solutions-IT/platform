...
CREATE TABLE IF NOT EXISTS referral_rewards (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT fk_referral_reward_hostinger_referrer FOREIGN KEY (referrer_id) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT fk_referral_reward_hostinger_referee FOREIGN KEY (referee_id) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT fk_referral_reward_hostinger_deposit FOREIGN KEY (deposit_id) REFERENCES deposits(id) ON DELETE CASCADE,
  CONSTRAINT fk_referral_reward_hostinger_reviewer FOREIGN KEY (reviewed_by) REFERENCES users(id) ON DELETE SET NULL
) ENGINE=InnoDB;
