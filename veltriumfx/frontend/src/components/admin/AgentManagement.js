            ...
            >
              <View className="gap-4">
                ...
                <View style={{ position: 'relative' }}>
                  ...
                  />
                  {editingAgent ? <Text className="mt-1 text-xs" style={{ color: colors.muted }}>Changing this password signs the staff member out. They can sign in again with the new password.</Text> : null}
                  <Pressable
