      ...
      <View className="flex-row items-center justify-between">
        <View className="min-w-0 flex-1 pr-3">
          ...
          <Text className="mt-2 text-lg font-medium" style={{ color: colors.text }}>
            {adminUser?.role === 'master' ? 'Master Console' : adminUser?.role === 'agent' ? 'Agent Console' : adminUser?.role === 'manager' ? 'Manager Console' : 'Admin Console'}
          </Text>
          <Text className="mt-0.5 text-xs" style={{ color: colors.muted }}>
            {adminUser?.role === 'master' ? 'Master control center' : adminUser?.role === 'agent' ? 'Agent operations panel' : adminUser?.role === 'manager' ? 'Manager operations panel' : 'Operations control center'}
          </Text>
        </View>
