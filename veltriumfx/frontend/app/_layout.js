  ...
  useEffect(() => {
    ...
    if (isAdminSubdomain) {
      ...
      if (pathname === '/' || pathname === '/index') {
        ...
        const mainDomain = isDev ? 'localhost:8082' : 'test.novafxm.com';
      ...
      if (searchParams.get('action') === 'logout') {
        localStorage.removeItem('veltriumfx_token');
        localStorage.removeItem('veltriumfx_user');
      ...
      if (
        ...
        const token = localStorage.getItem('veltriumfx_token');
        const user = localStorage.getItem('veltriumfx_user');
        ...
        const adminDomain = isDev ? 'admin.localhost:8082' : 'test-admin.novafxm.com';
