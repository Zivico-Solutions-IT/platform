          ...
          {activeSection === 'profile' ? (
            ...
            <View className="gap-8 lg:flex-row">
              <View className="items-center lg:w-[300px]">
                ...
                <Text className="mt-6 text-xl font-medium" style={{ color: colors.text }}>{profileForm.name || 'VeltriumFX User'}</Text>
                ...
                <View className="mt-4 flex-row items-center">
                  ...
                  <Text className="ml-2" style={{ color: colors.muted }}>Member since {user?.createdAt ? new Date(user.createdAt).toLocaleDateString() : 'VeltriumFX'}</Text>
                </View>
              </View>
          ...
          {activeSection === 'session' ? (
            <SettingsPanel icon={LogOut} title="Session" subtitle="Manage your current login session.">
              <View className="rounded-xl border p-4" style={{ backgroundColor: colors.panel, borderColor: colors.border }}>
                ...
                <Text className="mt-2 text-sm" style={{ color: colors.muted }}>Signed in as {user?.email || 'VeltriumFX user'}.</Text>
              </View>
