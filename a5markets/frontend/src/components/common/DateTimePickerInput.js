...
// Web browsers provide a native calendar and clock for datetime-local. Native
// builds retain a normal text fallback instead of losing the field entirely.
    ...
    return (
      <View className="mb-3 md:mb-4">
        <input
          ...
          onFocus={onFocus}
          onChange={(event) => onChangeText?.(toStoredValue(event.target.value))}
