...
const User = sequelize.define('User', {
  ...
  emailVerificationToken: { type: DataTypes.STRING(64), field: 'email_verification_token', allowNull: true },
  emailVerificationExpires: { type: DataTypes.DATE, field: 'email_verification_expires', allowNull: true },
