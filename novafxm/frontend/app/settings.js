          ...
          {activeSection === 'profile' ? (
            ...
            <View className={webProfileLayout ? 'flex-row gap-6' : 'gap-8 lg:flex-row'}>
              ...
              <View className="flex-1" style={webProfileLayout ? { flexDirection: 'row', flexWrap: 'wrap', columnGap: 16 } : undefined}>
                ...
                <SettingsInput label="Email Address" value={profileForm.email} editable={false} error={profileErrors.email} keyboardType="email-address" placeholder="email@example.com" containerStyle={webProfileLayout ? { width: '48%' } : undefined} />
